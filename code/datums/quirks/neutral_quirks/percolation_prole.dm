/datum/quirk/percolation_prole
	...
	gain_text = span_notice("You will see the fall of the espresso-drinking bourgeoisie even if it kills you.")
	lose_text = span_danger("The fires of cafe communism have died within you.")
