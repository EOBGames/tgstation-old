...
/obj/item/reagent_containers/cup/glass/mug/tiziran
	...
	desc = "A traditional Tiziran vessel for drinking hot drinks. Consists of a removable glass in an ornamented steel holder."
...
/obj/item/reagent_containers/cup/glass/coffee_cup/latte
	name = "\improper Take-a-Break latte"
	desc = "Contents include coffee and milk. In fact, that's pretty much it."
	list_reagents = list(/datum/reagent/consumable/coffee/caffe_latte = 30)
	resistance_flags = FREEZE_PROOF
	drink_type = BREAKFAST | SUGAR
