...
/obj/item/reagent_containers/cup/bottle/syrup_bottle/liqueur
	...
	desc = "A pump bottle containing mexican coffee-flavoured liqueur. In production since 1936, HONK."
	list_reagents = list(/datum/reagent/consumable/ethanol/kahlua = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/almond
	name = "bottle of almond syrup"
	desc = "A pump bottle containing almond syrup."
	list_reagents = list(/datum/reagent/consumable/almond_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/berry
	name = "bottle of berry syrup"
	desc = "A pump bottle containing berry syrup."
	list_reagents = list(/datum/reagent/consumable/berry_syrup = 50)
...
/obj/item/reagent_containers/cup/bottle/syrup_bottle/chocolate
	...
	desc = "A pump bottle containing chocolate syrup."
	list_reagents = list(/datum/reagent/consumable/chocolate_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/chili
	name = "bottle of chili syrup"
	desc = "A pump bottle containing chili syrup."
	list_reagents = list(/datum/reagent/consumable/chili_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/coffee
	name = "bottle of coffee syrup"
	desc = "A pump bottle containing coffee syrup."
	list_reagents = list(/datum/reagent/consumable/coffee_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/hazelnut
	name = "bottle of hazelnut syrup"
	desc = "A pump bottle containing hazelnut syrup."
	list_reagents = list(/datum/reagent/consumable/hazelnut_syrup = 50)
...
/obj/item/reagent_containers/cup/bottle/syrup_bottle/korta_nectar
	...
	list_reagents = list(/datum/reagent/consumable/kortanut_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/peppermint
	name = "bottle of peppermint syrup"
	desc = "A pump bottle containing peppermint syrup."
	list_reagents = list(/datum/reagent/consumable/peppermint_syrup = 50)

/obj/item/reagent_containers/cup/bottle/syrup_bottle/pumpkin_spice
	name = "bottle of pumpkin spice syrup"
	desc = "A pump bottle containing pumpkin spice syrup."
	list_reagents = list(/datum/reagent/consumable/pumpkin_spice_syrup = 50)
...
/obj/item/reagent_containers/cup/bottle/syrup_bottle/vanilla
	...
	list_reagents = list(/datum/reagent/consumable/vanilla_syrup = 50)
