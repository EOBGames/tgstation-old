...
/obj/item/paper/pamphlet/chilled
	...
	info = "Nanotrasen congratulates you on your recent transfer to its latest CHL-class outpost on the Icemoon Freyja, Arctic Post 13! \
		...
		If you have collected this pamphlet from the arrivals station, you are presently in Centre Ward. Centre Ward is home to the outpost's services, including the station's bar, cafeteria, library, dormitories, exercise facilities, and the Ward's centrepiece: our state of the art botanical garden, a welcome area of respite from the harsh cold outside. With climate control maintaining a balmy tropical environment year-round, it's always a pleasant place to head to when you're finished with your day's work. \
