...
/obj/item/paper/pamphlet/chilled
    name = "pamphlet - \'Welcome to Surface Station 13\'"
    info = "Nanotrasen congratulates you on your recent transfer to its latest Chilled-Class outpost on the Icemoon Freyja, Surface Station 13! \
        ...
        Centre Ward is also home to the outpost's command sector and brig, granting a commanding view for both departments over the surrounding area of the outpost. Ensure you are acquainted with the Security staff and your superiors. \
        Lastly, Centre Ward is also home to the Cargo department, who will supply you and your department with requisitions. The Cargo department is located on the upper level, to the east. \
