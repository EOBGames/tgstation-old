...
/obj/item/food/soup/hua_mulan_congee
	...
	foodtypes = MEAT | GRAIN | BREAKFAST
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/food/soup/red_porridge
	...
	desc = "Red beet 'porridge' with yoghurt. The name and vegetable ingredients obscure the sweet nature of the dish, which is commonly served as a dessert aboard the fleet."
	icon = 'icons/obj/food/moth.dmi'
