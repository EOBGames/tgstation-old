...
//MOTH FOOD 2: THE SQUEAKQUEL
/obj/item/food/grilled_eggplant
	name = "grilled eggplant"
	desc = "A halved and grilled eggplant, served with blackgrain bread and topped off with sop-oil."
	icon = 'icons/obj/food/moth.dmi'
	icon_state = "grilled_eggplant"
	food_reagents = list(/datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/consumable/sugar = 6)
	tastes = list("eggplant" = 1, "garlic" = 1, "oil" = 1, "bread" = 1)
	foodtypes = VEGETABLES | GRAIN

/obj/item/food/soup/baked_pumpkin_soup
	name = "kraktorënemæsch"
	desc = "Spiced with windgrass and töchtaüse berries, mothic pumpkin soup is considered an acquired taste to outsiders- though on the Fleet, there's plenty of opportunities to acquire that taste, as it's a favourite in the canteens when pumpkins are plentiful."
	icon = 'icons/obj/food/moth.dmi'
	icon_state = "baked_pumpkin_soup"
	food_reagents = list(/datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/consumable/sugar = 6)
	tastes = list("pumpkin" = 1, "cream" = 1, "exotic spices" = 1, "hemp" = 1)
	foodtypes = VEGETABLES | DAIRY
