...
/obj/item/storage/box/mothic_goods
	name = "Mothic Fresh Goods Pack"
	desc = "A box containing an assortment of fresh Mothic goods- fresh from the Fleet."
	icon_state = "moth_package"
	illustration = null

/obj/item/storage/box/mothic_goods/PopulateContents()
	for(var/i in 1 to 7)
		var/randomFood = pick_weight(list(/obj/item/food/grown/toechtauese = 5,
										  /obj/item/food/grown/herbs = 5,
										  /obj/item/food/mothic_pizza_dough = 5,
										  /obj/item/food/bread/corn = 5,
										  /obj/item/food/herby_cheese = 5,
...
/obj/item/storage/box/mothic_cans_sauce/PopulateContents()
	for(var/i in 1 to 6)
		var/randomFood = pick_weight(list(/obj/item/food/canned/tomatoes = 5,
